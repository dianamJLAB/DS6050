...
# origin workbooks
ORIG_LOCATION = './../data/hr_census_orig'
...
for i, key in enumerate(dataframes_dict):
    dataframes_dict[key].to_csv(SAVE_LOCATION + '/hr_census_clean/' + key + '.csv',index=False)
...
for i, key in enumerate(dataframes_piv_dict):
    dataframes_piv_dict[key].to_csv(SAVE_LOCATION + '/hr_census_cleanpivots/' + key + '.csv',index=False)
...
df_pop = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[0]))
df_pop.set_index(['year', 'jurisdiction'], inplace=True)

df_pop_change = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[1]))
df_pop_change.set_index(['year', 'jurisdiction'], inplace=True)

df_birth_rate = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[2]))
df_birth_rate.set_index(['year', 'jurisdiction'], inplace=True)

df_death_rate = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[3]))
df_death_rate.set_index(['year', 'jurisdiction'], inplace=True)

df_income = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[4]))
df_income.set_index(['year', 'jurisdiction'], inplace=True)

df_total_income = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[5]))
df_total_income.set_index(['year', 'jurisdiction'], inplace=True)

df_employment = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[6]))
df_employment.set_index(['year', 'jurisdiction'], inplace=True)

df_employment_mil = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[7]))
...
df_all.to_csv(SAVE_LOCATION + '/hr_census_cleanpivots/1970_2015_data.csv',index=False)

"""
Create csv with all the dataframes in the 1990 - 2017 data range
"""
# open the saved files (THIS ALSO CONFIRMS THE FILES WERE SAVED CORRECTLY) and set the indexes so .join can be used
df_laborforce = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[8]))
df_laborforce.set_index(['year', 'jurisdiction'], inplace=True)

df_unemploy = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[9]))
df_unemploy.set_index(['year', 'jurisdiction'], inplace=True)

df_unemploy_rate = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[10]))
df_unemploy_rate.set_index(['year', 'jurisdiction'], inplace=True)

df_employ_pop_ratio = pd.read_csv(os.path.join(SAVE_LOCATION + '/hr_census_cleanpivots', filenames_lst[11]))
...
df_all_1990_set.to_csv(SAVE_LOCATION + '/hr_census_cleanpivots/1990_2017_data.csv',index=False)
...
# save
df_all_all.to_csv(SAVE_LOCATION + '/hr_census_cleanpivots/all_data.csv',index=False)